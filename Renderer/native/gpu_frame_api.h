...
/* Optional caller-driven GPU composition API, versioned by exact struct size.
   ...
   a newer map, ordinary CPU request, configuration or reset retires the ticket.
...
struct c3x_renderer_gpu_command_v1 {
    int kind; /* 0 copy, 1 fill, 2 color key, 3 invert, 4 world-anchored ordered map quantization */
    c3x_renderer_i64 destination,source;
    int area[4],clip[4],source_x,source_y;
    unsigned color; /* quantize: (phase_x & 7) | ((phase_y & 7) << 3) */
};
