...
struct Input { float2 uv:TEXCOORD0;float material:TEXCOORD1;float4 world:TEXCOORD2; };
struct Pixel { float4 position:SV_POSITION;float2 uv:TEXCOORD0;nointerpolation float material:TEXCOORD1;float depth:TEXCOORD2; };
Pixel VS(Input i) { i.world.xyz+=offset.xyz;Pixel o;o.position=float4((dot(i.world.xyz,U.xyz)/6-page.x)*2-1,
 1-(dot(i.world.xyz,V.xyz)/6-page.y)*2,.5,1);o.uv=i.uv;o.material=i.material;o.depth=dot(i.world.xyz,L.xyz);return o; }
