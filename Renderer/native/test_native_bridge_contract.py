...
'''
    ...
    def test_native_topology_halo_is_checked_bounded_and_not_a_lod_input(self) -> None:
        ...
        self.assertIn("native_x + offset_x != tile->anchor_x", capture)
        self.assertIn("width * height > 16384", capture)
        self.assertIn("is->custom_renderer_tile_count = count", capture)
    ...
    def test_renderer_worker_owns_d3d_and_copies_immutable_frames(self) -> None:
        ...
        self.assertIn("job_tiles.assign(frame.tiles", worker)
    ...
    def test_connected_terrain_blends_without_tile_checkerboarding(self) -> None:
        ...
        self.assertIn("ground_grid_detail(tile,relief,draw_dunes", native)
    ...
    def test_m6_6_uses_real_terrain_relief_and_a_depth_target(self) -> None:
        ...
        # Executable grid/wrapped-UV checks live in test_ground_preparation.
        self.assertIn("ground_surface_uv(tile,frame,world_u,world_v,frequency)", native)
    ...
    def test_blit_replaces_the_map_surface_without_frame_accumulation(self) -> None:
        ...
        self.assertGreaterEqual(int(re.search(r"#define C3X_RENDERER_API_VERSION (\d+)u", api).group(1)), 17)
