# Archived retained-renderer checkpoints

Historical evidence through the native-cadence checkpoint; superseded intermediate
status and recommendations are not current authority. Follow
[the active implementation plan](../retained_renderer_plan.md). Measurements,
rejected mechanisms, acceptance boundaries and local evidence paths are preserved.
