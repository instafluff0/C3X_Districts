# Superseded ground-preparation checkpoints

Historical evidence and implementation decisions through the partial 1.2 slice.
Current status lives in [the roadmap](../retained_renderer_plan.md).
The former authorization questions are released by the current implementation request.
...
[the packed-content checkpoint](gpu_ready_content_20260915.md).
[Submission evidence](selected_submissions_20260915.md) and
[earlier findings](retained_renderer_checkpoints_20260915.md) remain preserved.
...
[Repair evidence and controls](resident_scroll_repair_20260915.md) preserve
