...
The normal sequence is edit, render/compare affected views, receive explicit
user approval, verify delivery, test the game, and record the integrated revision.
