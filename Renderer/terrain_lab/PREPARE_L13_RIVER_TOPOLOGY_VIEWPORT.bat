...
set "C3X_LAB_BIQ_VIEW=..\preview\out\terrain_lab\test_biq_l13_river_topology_192.csv"
...
:biq_found
node ..\tools\export_biq_terrain_scene.js "%C3X_LAB_BIQ%" "%C3X_LAB_BIQ_VIEW%" --window-columns 16 --window-rows 12 --window-shape diamond --prefer-river --require-river --prefer-wrap --require-wrap
